...
describe('concat', () => {
  ...
  it('error if first string is empty', () => {
    expect(() => {concat('','hello')}).to.throw('string is empty');
  });

  it('error if second string is empty', () => {
    expect(() => {concat('hello','')}).to.throw('string is empty');
  });

  it('error if both strings are empty', () => {
    expect(() => {concat('','')}).to.throw('string is empty');
  });
})